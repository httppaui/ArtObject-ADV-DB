...
-- Insert Artist
call spInsertARtist(111, 'Juan Luna');
call spInsertARtist(222, 'Vicente Manansala');
call spInsertARtist(333, 'Guillermo Tolentino');
-- Insert ArtObject
call spInsertArtObject(1, 'Spoliarium', 'The picture recreates a despoiling scene in a Roman circus where dead gladiators are stripped of weapons and garments', '111');
call spInsertArtObject(2, 'Madonna of the Slum', 'He painted an innovative mother and child, which reflected the poverty in postwar Manila.', '222');
call spInsertArtObject(3, 'Bonifacio Monument', 'A group sculpture composed of numerous figures massed around a central obelisk.', '333');
call spInsertArtObject(4, 'The Ruins', 'An architectural site of the remains of an ancestral Italian-styled home.', null);
-- Insert Painting
call spInsertPainting(1, 'Canvas');
call spInsertPainting(2, 'Masonite Board');
-- Insert Sculpture
call spInsertSculpture(3, 0, 13.7);
-- Retrieve Artist
